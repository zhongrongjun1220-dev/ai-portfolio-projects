...
原始项目快照保存在本仓库中，便于参考原设计。

## 新增可运行应用：CourseRAG
- 目录：`courserag/`
- 目标：把原 RAG 思路改造成可直接演示的课程资料问答助手
- 启动：`python courserag/app.py`
