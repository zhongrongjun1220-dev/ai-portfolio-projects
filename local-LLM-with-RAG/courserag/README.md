...
> 公开仓库地址：[https://github.com/zhongrongjun1220-dev/courserag-2026](https://github.com/zhongrongjun1220-dev/courserag-2026)
...
`ash
git clone https://github.com/zhongrongjun1220-dev/courserag-2026.git
cd courserag-2026
python -m venv .venv
...
**Q: 回答质量不稳定怎么办？**
A: 先检查上传资料是否完整；可以调整 pp.py 里的 TOP_K；也可以替换更强的大模型。若 Chroma 出现 hnsw 相关错误，删除 storage/ 后重新上传资料即可。
